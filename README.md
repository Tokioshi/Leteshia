...
Leteshia is a powerful, premium, and highly extensible multi-purpose Discord bot built with **discord.js v14**. It comes packed with advanced integrations like intelligent AI chatbot agents with RAG capabilities, automated social media video downloading and compression, a 24/7 Lofi music player, dynamic Canvas-drawn greeting cards, a secure personal password manager, and interactive ticket support systems.
...
*   🤖 **Intelligent AI Chatbot & Dynamic RAG (Retrieval-Augmented Generation)**
    ...
    *   Maintains conversation memory history (stores the last 20 messages with a 20-minute expiration).
...
*   🔑 **Secure Ephemeral Password Manager**
    *   Private password safe using the `/password` slash commands.
...
3.  **FFmpeg** (Crucial! Required by the automated video compression module to process heavy downloads)
...
Open the pre-configured [config.js](file:///c:/Users/Tiko/Documents/Leteshia/config.js) file and replace the mock/existing Snowflakes with your own Discord IDs:
